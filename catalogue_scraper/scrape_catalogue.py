...
class ScrapeCatalogue:
    def __init__(self, url: str, num_pages: int, proxy_string: Optional[str] = None):
        """
            Args:
    ...
    def get_product_title(self, product_soup: BeautifulSoup) -> str:
        """
    ...
    def get_product_price(self, product_soup: BeautifulSoup) -> str:
        """
    ...
    def get_image_url(self, product_soup: BeautifulSoup) -> str:
        """
    ...
    def check_url_accessibility(self) -> None:
        """
